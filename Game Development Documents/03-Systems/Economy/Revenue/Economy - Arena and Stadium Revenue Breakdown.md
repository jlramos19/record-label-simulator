### **`Economy - Arena and Stadium Revenue Breakdown (Capacities 1,000 to 300,000)`**
...
| `3,000` | `300,000` | `75,000,000` | `15,000,000` | `30,000,000` | `15,000,000` | `9,900,000` | `5,100,000` |
| `4,000` | `400,000` | `100,000,000` | `20,000,000` | `40,000,000` | `20,000,000` | `13,200,000` | `6,800,000` |
| `5,000` | `500,000` | `125,000,000` | `25,000,000` | `50,000,000` | `25,000,000` | `16,500,000` | `8,500,000` |
| `...` | `...` | `...` | `...` | `...` | `...` | `...` | `...` |
| `49,000` | `4,900,000` | `1,225,000,000` | `245,000,000` | `490,000,000` | `245,000,000` | `161,700,000` | `83,300,000` |
...
| `70,000` | `14,000,000` | `3,500,000,000` | `700,000,000` | `1,400,000,000` | `700,000,000` | `462,000,000` | `238,000,000` |
| `80,000` | `16,000,000` | `4,000,000,000` | `800,000,000` | `1,600,000,000` | `800,000,000` | `528,000,000` | `272,000,000` |
| `90,000` | `18,000,000` | `4,500,000,000` | `900,000,000` | `1,800,000,000` | `900,000,000` | `594,000,000` | `306,000,000` |
| `...` | `...` | `...` | `...` | `...` | `...` | `...` | `...` |
| `300,000` | `60,000,000` | `15,000,000,000` | `3,000,000,000` | `6,000,000,000` | `3,000,000,000` | `1,980,000,000` | `1,020,000,000` |

### **`Key Points:`**

1. **`Total Revenue per Show:`** `This varies with the capacity of the venue and the ticket price.`  
