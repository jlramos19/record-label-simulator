`Below is a documentation-style overview of the in-game charts that exist in Gaia for Record Label Simulator. These charts measure content performance (tracks, projects, promotional content, tours) at local, national, and international levels.`
...
`Each of the three countries also tracks a national chart, aggregating performance from all regions (capital + elsewhere).`

* **`Annglora National Chart`**  
