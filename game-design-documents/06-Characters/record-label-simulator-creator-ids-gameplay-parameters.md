**`Record Label Simulator — Creator IDs: Gameplay Parameters`**
...
* **`Minitones (Children):`** `5–12`  
* **`Meloteens (Teenagers):`** `13–19`  
* **`Youngweavers (Young Adults):`** `20–25`  
* **`Adult:`** `26–45`  
* **`Middle-aged:`** `46–65`  
* **`Elder:`** `66–85`  
* **`Legend:`** `86–120`

`Because of the rise of parasocial relationships from the audience, the government mandates that no single Creator consistently creates or performs the same content, to keep content fresh and discourage unhealthy attachment.`
