...
- Creator roster now groups signed Creator IDs into Songwriter, Vocalist, and Producer columns to match the CCC layout.
...
- Create Content uses stage buttons (Sheet/Demo/Master) and studio slot columns (5 slots per column; 3/2/1 columns for Songwriters/Vocalists/Producers).
