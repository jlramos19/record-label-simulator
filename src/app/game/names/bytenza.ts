...
const BYTENZA_GIVEN_NAMES_2_WOMAN_START = 45;
const BYTENZA_GIVEN_NAMES_2_NONBINARY_SET = new Set([
  "Jiwoo",
  "Jimin",
  "Yujin",
  "Jisu",
...
export const BYTENZA_GIVEN_NAMES_2_MAN = BYTENZA_GIVEN_NAMES_2.slice(0, BYTENZA_GIVEN_NAMES_2_WOMAN_START);
export const BYTENZA_GIVEN_NAMES_2_WOMAN = BYTENZA_GIVEN_NAMES_2.slice(BYTENZA_GIVEN_NAMES_2_WOMAN_START);
export const BYTENZA_GIVEN_NAMES_2_NONBINARY = BYTENZA_GIVEN_NAMES_2.filter((entry) => (
  BYTENZA_GIVEN_NAMES_2_NONBINARY_SET.has(entry.romanized)
));

export const BYTENZA_GIVEN_NAMES_3_MAN = [];
export const BYTENZA_GIVEN_NAMES_3_WOMAN = [];
export const BYTENZA_GIVEN_NAMES_3_NONBINARY = BYTENZA_GIVEN_NAMES_3.slice();

export const BYTENZA_GIVEN_NAMES_4_MAN = [];
export const BYTENZA_GIVEN_NAMES_4_WOMAN = [];
export const BYTENZA_GIVEN_NAMES_4_NONBINARY = BYTENZA_GIVEN_NAMES_4.slice();

export const BYTENZA_GIVEN_NAMES_MAN = [
  ...BYTENZA_GIVEN_NAMES_2_MAN,
  ...BYTENZA_GIVEN_NAMES_3_MAN,
  ...BYTENZA_GIVEN_NAMES_4_MAN,
];

export const BYTENZA_GIVEN_NAMES_WOMAN = [
  ...BYTENZA_GIVEN_NAMES_2_WOMAN,
  ...BYTENZA_GIVEN_NAMES_3_WOMAN,
  ...BYTENZA_GIVEN_NAMES_4_WOMAN,
];

export const BYTENZA_GIVEN_NAMES_NONBINARY = [
