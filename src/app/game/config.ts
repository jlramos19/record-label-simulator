...
export const CREATOR_CATHARSIS_INACTIVITY_MAX_PCT = 0.35;
export const CREATOR_CATHARSIS_INACTIVITY_RECOVERY_DAYS = 14;
...
export const TREND_RANKING_HISTORY_WEEKS = 20;
export const TREND_PEAKING_TOP_RANK = 5;
export const TREND_PEAKING_MAX_WEEKS = 16;
export const TREND_PEAKING_DISINTEREST_START = 8;
export const TREND_DOMINANCE_MIN_WEEKS = 4;
export const TREND_DOMINANCE_MAX_WEEKS = 7;
export const TREND_DOMINANCE_DECAY_MAX = 0.35;
export const TREND_EMERGING_WEEKS = 4;
export const TREND_EMERGING_ACTIVITY_DEBUFF = 0.75;
