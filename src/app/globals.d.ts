...
declare const LABEL_NAMES: string[];
declare const NAME_PARTS: {
  labelPrefix: string[];
  labelSuffix: string[];
  actPrefix: string[];
  actSuffix: string[];
  ...
  trackVerb: string[];
  trackNoun: string[];
  eraDescriptor: string[];
  eraPhase: string[];
};
declare const TRACK_TITLE_TEMPLATES: string[];
declare const PROJECT_TITLE_TEMPLATES: string[];
declare const PROJECT_TITLES: string[];
declare const ERA_NAME_TEMPLATES: string[];
