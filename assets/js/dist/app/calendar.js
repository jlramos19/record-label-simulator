...
export function useCalendarProjection({ startEpochMs, anchorWeekIndex, pastWeeks = 0, futureWeeks = 3, tab = "label", filters = {}, sources = {} }) {
    ...
    const activeEvents = [];
    if (showLabel && filters.labelScheduled !== false)
    ...
    if (showRivals && filters.rivalReleased !== false)
        activeEvents.push(...rivalReleased);
