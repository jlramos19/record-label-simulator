...
import { ANGLORAN_GIVEN_NAMES, ANGLORAN_GIVEN_NAMES_MAN, ANGLORAN_GIVEN_NAMES_NONBINARY, ANGLORAN_GIVEN_NAMES_WOMAN, ANGLORAN_SURNAMES } from "./names/annglora.js";
import { CROWLYA_GIVEN_NAMES, CROWLYA_GIVEN_NAMES_MAN, CROWLYA_GIVEN_NAMES_NONBINARY, CROWLYA_GIVEN_NAMES_WOMAN, CROWLYA_SURNAMES } from "./names/crowlya.js";
import { BYTENZA_GIVEN_NAMES_2_MAN, BYTENZA_GIVEN_NAMES_2_NONBINARY, BYTENZA_GIVEN_NAMES_2_WOMAN, BYTENZA_GIVEN_NAMES_2, BYTENZA_GIVEN_NAMES_3_MAN, BYTENZA_GIVEN_NAMES_3_NONBINARY, BYTENZA_GIVEN_NAMES_3_WOMAN, BYTENZA_GIVEN_NAMES_3, BYTENZA_GIVEN_NAMES_4_MAN, BYTENZA_GIVEN_NAMES_4_NONBINARY, BYTENZA_GIVEN_NAMES_4_WOMAN, BYTENZA_GIVEN_NAMES_4, BYTENZA_GIVEN_NAMES_ALL, BYTENZA_GIVEN_NAMES_MAN, BYTENZA_GIVEN_NAMES_NONBINARY, BYTENZA_GIVEN_NAMES_WOMAN, BYTENZA_SURNAMES } from "./names/bytenza.js";
import { ERA_NAME_TEMPLATES, LABEL_NAMES, NAME_PARTS, PROJECT_TITLE_TEMPLATES, PROJECT_TITLE_TRANSLATIONS, PROJECT_TITLES, TRACK_TITLE_TEMPLATES } from "./names/templates.js";
...
export { CREATOR_NAME_PARTS, EAST_ASIAN_NAMES, ERA_NAME_TEMPLATES, LABEL_NAMES, LATIN_NAMES, NAME_PARTS, PROJECT_TITLE_TEMPLATES, PROJECT_TITLE_TRANSLATIONS, PROJECT_TITLES, RLS_GIVEN_NAMES, TRACK_TITLE_TEMPLATES, WESTERN_NAMES };
